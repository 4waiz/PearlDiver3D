...
// FIX: Make water more blue and opaque
const waterMat = new THREE.MeshPhongMaterial({ color: 0x42a5f5, transparent:true, opacity:0.9, side:THREE.DoubleSide, shininess:80, specular:0xefefef });
...
// FIX: Correct the trunk's y-position to prevent floating trees
